	...
	public static void main(String[] args) throws IOException {
		...
		Session session = Session.getDefaultInstance(props, new javax.mail.Authenticator() {
			protected PasswordAuthentication getPasswordAuthentication() {
				return new PasswordAuthentication("abhijitsamantmech@gmail.com", "9437166230");
			}
		});
		// compose message
		try {
		...
		try {
			...
			msg.setReplyTo(InternetAddress.parse("abhijit.samant07@gmail.com", false));

			msg.setSubject("Test Report by Automation", "UTF-8");

			msg.setSentDate(new Date());

			msg.setRecipients(Message.RecipientType.TO, InternetAddress.parse("abhijit.samant07@gmail.com"));
